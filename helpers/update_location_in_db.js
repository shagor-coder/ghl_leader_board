...
const update_location_in_db = async (data) => {
  try {
    const { id, total_revenew, total_contacts, months } = data;
    ...
    new_months[month][name_of_month].total_contacts = total_contacts;
    new_months[month][name_of_month].total_revenew = total_revenew;
